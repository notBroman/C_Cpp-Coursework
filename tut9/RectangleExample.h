...
public:
	...
	rectangle()
	{
		...
		init_flag=false;
        rectangle::rectangle_ID = ++rectangle::rectangle_instances_created_count;
        rectangle::rectangle_instances_alive_count++;

	}

    ~rectangle(){
        rectangle::rectangle_instances_alive_count--;
        rectangle::initialized_rectangle_instances_count--;
    }
    ...
    static void printRectangleCount(){
        cout << "Rectangles Created: " << rectangle::rectangle_instances_created_count << endl;
        cout << "Rectangles Alive: " << rectangle::rectangle_instances_alive_count << endl;
        cout << "Rectangles Initialized :" << rectangle::initialized_rectangle_instances_count << endl;
        cout << endl;
    }
